...
acc=$(python inference.py --model cifar10 --shards 10 --slices 1 --dataset datasets/cifar10/datasetfile --batch_size 32 --dropout_rate 0.2 --container "cifar10" | tail -n 1)
